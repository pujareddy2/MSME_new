...
public class DataInitializer implements CommandLineRunner {
    ...
    private List<ProblemStatement> createDefaultProblems() {
        ...
        problems.add(buildProblem(3L, "AI Based MSME Market Prediction", "Software", "Artificial Intelligence", "2025-07-25"));
        problems.add(buildProblem(4L, "Blockchain for MSME Supply Chain Transparency", "Software", "Cyber Security", "2025-07-28"));
        problems.add(buildProblem(5L, "Smart Waste Management using IoT", "Hardware", "Smart Cities", "2025-07-30"));
        problems.add(buildProblem(6L, "AI Powered Financial Risk Assessment for MSMEs", "Software", "FinTech", "2025-07-20"));
        problems.add(buildProblem(7L, "Automated MSME Loan Eligibility System", "Software", "FinTech", "2025-07-21"));
        problems.add(buildProblem(8L, "AI Chatbot for MSME Government Schemes", "Software", "Artificial Intelligence", "2025-07-23"));
        ...
        problems.add(buildProblem(11L, "Digital Platform for MSME Vendor Discovery", "Software", "E-Commerce", "2025-07-27"));
        ...
        problems.add(buildProblem(18L, "AI Based MSME Product Recommendation System", "Software", "E-Commerce", "2025-07-24"));
        ...
        problems.add(buildProblem(21L, "Digital Inventory System for MSMEs", "Software", "E-Commerce", "2025-07-27"));
        ...
        problems.add(buildProblem(26L, "Digital Marketplace for Rural MSMEs", "Software", "E-Commerce", "2025-07-22"));
        return problems;
    }
    ...
    private ProblemStatement buildProblem(Long id, String title, String category, String theme, String deadline) {
        ...
        problemStatement.setProblemDescription(title + " for MSME hackathon submissions.");
        problemStatement.setDomain(category);
        problemStatement.setOrganizationName("MSME");
